...
class IntentService:
    ...
    def classify(self, message: str) -> tuple:
        ...
        if self.gemini_service.api_key:
            return self.gemini_service.understand_intent(message)
    ...
    def _keyword_classify(self, message: str) -> str:
        ...
        keywords = {
            "registration": ["register", "sign up", "enroll", "registration"],
            "deadlines": ["deadline", "when", "date", "timeline", "last day"],
            "voting_methods": ["mail", "absentee", "early", "in person", "vote by"],
            "requirements": ["id", "document", "need", "require", "eligible", "qualify"],
